...
@RestController
@RequestMapping({OrderErrorController.ERROR_PATH})
public class OrderErrorController extends AbstractErrorController {

    static final String ERROR_PATH = "/error";

    ErrorAttributes errorAttributes;

    public OrderErrorController(ErrorAttributes errorAttributes) {
