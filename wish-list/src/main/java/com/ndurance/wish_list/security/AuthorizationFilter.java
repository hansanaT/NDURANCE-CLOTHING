package com.ndurance.wish_list.security;


import com.ndurance.wish_list.SpringApplicationContext;
import com.ndurance.wish_list.feign_client.model.UserRest;
...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) throws ParseException, JOSEException {
        ...
        UserRest user = (UserRest) tokenConverter.validateTokenSignature(token, request);
