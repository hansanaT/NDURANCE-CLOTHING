...
@RestController
@RequestMapping({WishListErrorController.ERROR_PATH})
public class WishListErrorController extends AbstractErrorController {

    static final String ERROR_PATH = "/error";

    ErrorAttributes errorAttributes;

    public WishListErrorController(ErrorAttributes errorAttributes) {
